...
We as members, contributors, and maintainers pledge to make participation in the @blamejs/stash project a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, religion, or sexual identity and orientation.
...
If you experience or witness behavior that violates this Code of Conduct, report it privately to the maintainer at the email address listed on the maintainer's GitHub profile ([dotCooCoo](https://github.com/dotCooCoo)).
